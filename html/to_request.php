...
$sql_select = "SELECT * FROM trash WHERE id_request = $id";
...
if ($result->num_rows > 0) {
    ...
    $sql_move = "INSERT INTO request (id_request, description, cabinet, time, name, photo, phone)
    ...
    if ($conn->query($sql_move) === TRUE) {
        ...
        $sql_delete = "DELETE FROM trash WHERE id_request = $id";
